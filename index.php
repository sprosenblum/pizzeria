...
<main>
  ...
  <div class="container"> <!-- missing closing? -->
    ...
    <div class="row">
      <div class="col-12 text-center">
        <h2 class="mb-3 font-weight-bold">Sauces</h2>
      </div>
    </div>
...
<!-- </div> div started in header.php
</div> div started in header.php -->

</body> <!-- body started in header.php -->
